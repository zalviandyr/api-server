...
const endpoint = {
    ...
    fbVideo: (query) => new Promise((resolve, rejects) => {
        ...
        if (query.url) {
            ...
            errorResponse.status_code = 400
            errorResponse.message = 'Silahkan input query url, contoh: ?url=https://facebook.com/video'
            rejects(errorResponse)
        }
    }),
    ...
    igProfile: (query) => new Promise((resolve, rejects) => {
        ...
        if (query.username) {
            ...
            errorResponse.status_code = 400
            errorResponse.message = 'Silahkan input query username, contoh: ?username=zukronalviandy11'
            rejects(errorResponse)
        }
    }),
    ...
    quoteMaker: (query) => new Promise((resolve, rejects) => {
        ...
        if (query.author && query.quote) {
            ...
            errorResponse.status_code = 400
            errorResponse.message = 'Silahkan masukkan query author dan quote, contoh: ?author=sae kadal&quote=wayahe wayahe'
            rejects(errorResponse)
        }
    }),
    ...
    animePic: (query) => new Promise((resolve, rejects) => {
        ...
        if (query.genre) {
            ...
            if (genreList.includes(genre)) {
                ...
                errorResponse.status_code = 400
                errorResponse.message = 'Genre tidak ada'
                rejects(errorResponse)
            }
        } else {
            errorResponse.status_code = 400
            errorResponse.message = 'Silahkan input query genre, contoh ?genre=random'
            rejects(errorResponse)
        }
    }),
    ...
    speech: (query) => new Promise((resolve, rejects) => {
        ...
        if (query.lang && query.text) {
            ...
            if (langList.includes(lang)) {
                ...
                errorResponse.status_code = 400
                errorResponse.message = 'Bahasa tidak ada'
                rejects(errorResponse)
            }
        } else {
            errorResponse.status_code = 400
            errorResponse.message = 'Silahkan input query lang dan text, contoh ?lang=en&text=hai'
            rejects(errorResponse)
        }
    }),
    ...
    translate: (query) => new Promise((resolve, rejects) => {
        ...
        if (query.text) {
            ...
            errorResponse.status_code = 400
            errorResponse.message = 'Silahkan input query text, contoh: ?text=こんにちは'
            rejects(errorResponse)
        }
    }),
    ...
    quote: (query) => new Promise((resolve, rejects) => {
        ...
        if (query.type) {
            ...
            if (typeList.includes(type)) {
                ...
                errorResponse.status_code = 400
                errorResponse.message = 'Type not found'
                rejects(errorResponse)
            }
        } else {
            errorResponse.status_code = 400
            errorResponse.message = 'Silahkan input type, contoh: ?type=random'
            rejects(errorResponse)
        }
    }),
}
